...
Files: macbook-16.glb [639.28KB] > C:\Users\defaultuser0\OneDrive\Documents\projects\React.js\mackbook_gsap_web\public\models\macbook-16-transformed.glb [629.72KB] (1%)
...
export default function MacbookModel16(props) {
  ...
  useEffect(() => {
    scene.traverse((child)=> {
      if(child.isMesh){
        // Change color only if the part name is NOT no ChangesParts
